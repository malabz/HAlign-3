...
Align mt_genome.fasta dataset by HAlign3 with the setting of: 5 CPU cores for paralization alignment, the 7th sequence as center sequence during alignment, output alignment block without sequence identifiers
